<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは広島県内における新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、三重県内の高専生チームが開発・開設したものを利用して作成したものになります．<br />
      <br />
      ...
      <br />
      広島県による公式情報と客観的な数値をわかりやすく伝えることで、広島県にお住まいの方や，広島県内に拠点を持つ企業の方、広島県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。
    </TextCard>
    ...
    <TextCard title="免責事項">
      当サイトに掲載されている情報の正確性については万全を期していますが、三重県や当サイトの開発者・関係者は、利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。<br />
      <br />
