<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは広島市内における新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、複製・改変が許されたオープンソースライセンスを利用して広島市と協議しながら、広島市立大学ネットワーク科学研究室が作成したものになります。<br />
      広島市による公式情報と客観的な数値をわかりやすく伝えることで、広島市にお住まいの方や、広島市内に拠点を持つ企業の方、広島市を訪れる方が、現状を把握して適切な対策をとれるようにすることを目的としています。<br />
      <br />
      ...
      <br />
      広島市による公式情報と客観的な数値をわかりやすく伝えることで、広島市にお住まいの方や，広島市内に拠点を持つ企業の方、広島市を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。
    </TextCard>
    ...
    <TextCard title="免責事項">
      当サイトに掲載されている情報の正確性については万全を期していますが、広島市や当サイトの開発者・関係者は、利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。<br />
      <br />
    ...
    <TextCard title="ソースコードについて">
      ...
      <a href="https://github.com/inspired-fox/covid19-hirosima_city">
        GitHub リポジトリ
      </a>
      をご確認ください。
    </TextCard>
